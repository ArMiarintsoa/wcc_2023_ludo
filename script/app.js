...
var clicked = false;
var currpawn = "";
var allcolor = ["MENA", "MANGA", "MAINTSO", "MAVO"];
var pawnOut = {MENA:0,MANGA:0,MAINTSO:0,MAVO:0}
function HaveHover() {
    var count = 0;
    var toKill = "";
...
function changePlayer() {
    if (num != 6){
        ...
        switch (text.innerText) {
            case "MENA": 
                text.innerText = "MANGA";
                text.style.color = "blue"; break;
            case "MANGA": 
                text.innerText = "MAVO";
                text.style.color = "yellow"; 
                break;
            case "MAVO": 
                text.innerText = "MAINTSO";
...
var positions = {
    MENApawn1: 0, MENApawn2: 0, MENApawn3: 0, MENApawn4: 0,
    MANGApawn1: 0, MANGApawn2: 0, MANGApawn3: 0, MANGApawn4: 0,
    MAINTSOpawn1: 0, MAINTSOpawn2: 0, MAINTSOpawn3: 0, MAINTSOpawn4: 0,
    MAVOpawn1: 0, MAVOpawn2: 0, MAVOpawn3: 0, MAVOpawn4: 0
};
var onboard = {
    MENApawn1: 0, MENApawn2: 0, MENApawn3: 0, MENApawn4: 0,
    MANGApawn1: 0, MANGApawn2: 0, MANGApawn3: 0, MANGApawn4: 0,
...
function CheckForWinner() {
    if (pawnOut[currcolor] == 4) {
        ...
        player.innerText = "Ny mpandresy dia "+currcolor;
    }
}
function stepDown() {
...
function ResetPawn(victim) {
    ...
    switch (victim) {
        case "MENApawn1": pawnToMove.style.top = 149 + "px"; pawnToMove.style.left = 442 + "px"; break;
        case "MENApawn2": pawnToMove.style.top = 102 + "px"; pawnToMove.style.left = 395 + "px"; break;
        case "MENApawn3": pawnToMove.style.top = 55 + "px"; pawnToMove.style.left = 442 + "px"; break;
        case "MENApawn4": pawnToMove.style.top = 102 + "px"; pawnToMove.style.left = 490 + "px"; break;
        case "MANGApawn1": pawnToMove.style.top = 451 + "px"; pawnToMove.style.left = 490 + "px"; break;
        case "MANGApawn2": pawnToMove.style.top = 451 + "px"; pawnToMove.style.left = 395 + "px"; break;
        case "MANGApawn3": pawnToMove.style.top = 404 + "px"; pawnToMove.style.left = 442 + "px"; break;
        case "MANGApawn4": pawnToMove.style.top = 498 + "px"; pawnToMove.style.left = 442 + "px"; break;
        case "MAINTSOpawn1": pawnToMove.style.top = 149 + "px"; pawnToMove.style.left = 93 + "px"; break;
        case "MAINTSOpawn2": pawnToMove.style.top = 102 + "px"; pawnToMove.style.left = 140 + "px"; break;
        case "MAINTSOpawn3": pawnToMove.style.top = 55 + "px"; pawnToMove.style.left = 93 + "px"; break;
        case "MAINTSOpawn4": pawnToMove.style.top = 102 + "px"; pawnToMove.style.left = 47 + "px"; break;
        case "MAVOpawn1": pawnToMove.style.top = 451 + "px"; pawnToMove.style.left = 47 + "px"; break;
        case "MAVOpawn2": pawnToMove.style.top = 451 + "px"; pawnToMove.style.left = 140 + "px"; break;
        case "MAVOpawn3": pawnToMove.style.top = 404 + "px"; pawnToMove.style.left = 93 + "px"; break;
        case "MAVOpawn4": pawnToMove.style.top = 498 + "px"; pawnToMove.style.left = 93 + "px"; break;
